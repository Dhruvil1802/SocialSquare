...
#                 print("otp is here",request.session['otp'])
...
#             print("user_blocked_by",user_blocked_by)
...
#                     requested_users_post = UserPost.objects.filter(user__in = following)
